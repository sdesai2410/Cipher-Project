...
class CaesarDec_FullDictMainCommandPrompt : public CaptureCinCout {};

const string TEXT_PROMPT = "Enter the text to decrypt:";

TEST_F(CaesarDec_FullDictMainCommandPrompt, CommandPrompt) {
  input << "d" << endl;
  input << "whatever" << endl;
  input << "x";
  ...
  ASSERT_THAT(actual_output, HasSubstr(TEXT_PROMPT)) << "\nIncorrect prompt";
}
