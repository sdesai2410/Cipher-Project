...
class SubstDec_EnglishnessCommandPrompt : public CaptureCinCout {};

const string TEXT_PROMPT = "Enter a string for scoring:";

TEST_F(SubstDec_EnglishnessCommandPrompt, CommandPrompt) {
  input << "e" << endl;
